  ...
  (() => {
    ...
    const Y = {
      loopCreate: function () {
        ...
        for (let e = l.length - 1; e >= 0; e -= 1)
          n.prepend(L(l[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      },
      loopFix: function () {
        const e = this;
    ...
    function U(e) {
      ...
      if (!s.allowTouchMove)
        return (
          L(o.target).is(i.focusableElements) || (s.allowClick = !1),
          void (
            i.isTouched &&
            (Object.assign(a, {
              startX: d,
      ...
      s({
        ...
        i("click", (e, s) => {
          const { $nextEl: i, $prevEl: a } = t.navigation,
            l = s.target;
          if (t.params.navigation.hideOnClick && !L(l).is(a) && !L(l).is(i)) {
            if (
              t.pagination &&
              t.params.pagination &&
    ...
    window.addEventListener("load", function (e) {
      document.querySelector(".using__slider") &&
        ...
        document.querySelector(window.innerWidth > 769) &&
          new ue(".scan__slider", {
            modules: [fe, ge],
            observer: !0,
            observeParents: !0,
            ...
            breakpoints: {
              320: {
                ...
                autoHeight: !0,
                pagination: {
                  el: ".slider-quality__pagging._scan",
                  clickable: !0,
                },
              },
              768: { slidesPerView: 2, spaceBetween: 20 },
              992: { slidesPerView: "auto", spaceBetween: 50 },
            },
          }),
        document.querySelector(".ambasador__slider") &&
          new ue(".ambasador__slider", {
            modules: [fe, ge],
            observer: !0,
            observeParents: !0,
            slidesPerView: 1,
    ...
    setTimeout(() => {
      ...
      window.addEventListener("load", function (e) {
        ...
        function c(e) {
          ...
          } else "resize" === c && (s && s.length && r(s), a && a.length && l(a));
        }
        t.length &&
